...
export default function SignIn() {
  ...
  const handleSubmit = async () => {
    try {
        ...
        let response = await axios.post('http://localhost:4000/api/v1/auth/login', { email, password });
    ...
    try {
        const agentResponse = await axios.post('http://localhost:4000/api/v1/agents/login', { email, password });
